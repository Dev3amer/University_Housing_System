...
namespace UniversityHousingSystem.Infrastructure.Migrations
{
    ...
    [Migration("20250305223345_roomphoto1")]
    partial class roomphoto1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityHousingSystem.Data.Entities.HighSchoolDepartment", b =>
                {
                    b.Property<int>("HighSchoolDepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HighSchoolDepartmentId"));
                    ...
                    b.HasKey("HighSchoolDepartmentId");

                    b.HasIndex("HighSchoolId", "Name")
                        .IsUnique();

                    b.ToTable("HighSchoolDepartments", (string)null);
                });
            ...
            modelBuilder.Entity("UniversityHousingSystem.Data.Entities.Student", b =>
                {
                    ...
                    b.HasIndex("NewStudentId")
                        .IsUnique()
                        .HasFilter("[NewStudentId] IS NOT NULL");

                    b.HasIndex("OldStudentId")
                        .IsUnique()
                        .HasFilter("[OldStudentId] IS NOT NULL");
            ...
            modelBuilder.Entity("UniversityHousingSystem.Data.Entities.Student", b =>
                {
                    ...
                    b.HasOne("UniversityHousingSystem.Data.Entities.NewStudent", "NewStudent")
                        .WithOne("Student")
                        .HasForeignKey("UniversityHousingSystem.Data.Entities.Student", "NewStudentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("UniversityHousingSystem.Data.Entities.OldStudent", "OldStudent")
                        .WithOne("Student")
                        .HasForeignKey("UniversityHousingSystem.Data.Entities.Student", "OldStudentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("UniversityHousingSystem.Data.Entities.HighSchool", b =>
                {
                    b.Navigation("HighSchoolDepartment");
